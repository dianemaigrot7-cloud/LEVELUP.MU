...
- **H1 hero** : « Transformer vos équipes en moteurs d'innovation. » (choisi contre une variante urgence « en 90 jours »).
- **CTA principal unifié partout** : « Réserver mon diagnostic offert » / « Book my free diagnostic » — hero, CTA flottant desktop, barre sticky mobile. Meta : « Disponible · 1er rdv sous 5 jours ».
...
- Prix des programmes — remplacés par des CTA « Demander un devis » (`mailto:hello@levelup.mu`).
...
- Email de contact : `hello@levelup.mu`.
